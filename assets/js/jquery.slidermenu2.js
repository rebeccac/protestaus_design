...
;(function($) {
	...
	function Slidermenu(element, options) {
		...
		$(".sliderButton").click( function(e) {
			e.preventDefault();
			$("#slider").toggleClass("slidermenu-right").toggleClass("slidermenu-pushed");
			$('body').toggleClass("page-body-right").toggleClass("page-body-pushed");
			// $("#slider").toggleClass("slidermenu-right").toggleClass("slidermenu-pushed");
	...
	Slidermenu.prototype.init = function() {
		$('body').addClass("page-body page-body-right");
		this.element.addClass(this.config.containerClass).addClass("slidermenu-right").css("background-color", this.config.menuBgColor);
